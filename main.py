...
from ACGAN_ResNet import ACGAN_ResNet
...
def parse_args():
    ...
    parser.add_argument('--gan_type', type=str, default='ACGAN',
                        choices=['CGAN','ACGAN','ACGAN_ResNet'],
                        help='The type of conditional GAN')
    parser.add_argument('--dataset', type=str, default='mnist', 
                        choices=['mnist', 'fashion-mnist', 'celebA', 'anime'],
                        help='The name of dataset')
    parser.add_argument('--epoch', type=int, default=80000, help='The number pf epochs to run')
...
def main():    
    ...
    models = [CGAN, ACGAN, ACGAN_ResNet]
